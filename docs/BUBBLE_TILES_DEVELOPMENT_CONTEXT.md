...
- The local working tree is the authoritative v1.9 release candidate.
- Repository HEAD contains the committed v1.8.1 release.
- The local v1.9 work should not be committed, pushed, published, or deployed unless the user explicitly asks. The user always performs the commit themselves.
- The browser title, header wordmark, About dialog, Help heading, README, and Version History identify the current work as v1.9.
...
The detailed application version is v1.9 in the current files, and Version History is shown in the modal content in [index.html](../index.html). Detailed version displays and historical entries should remain consistent when release-version changes are requested.
