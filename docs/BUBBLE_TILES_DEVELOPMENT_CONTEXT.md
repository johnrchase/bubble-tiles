...
- The local working tree is the authoritative v1.7 release candidate.
- Repository HEAD and the configured GitHub remote contain the committed v1.6.1 export fixes.
- The local v1.7 work should not be committed, pushed, published, or deployed unless the user explicitly asks.
- The visible application title, README, and Version History identify the current work as v1.7. Committing or publishing still requires the user's explicit approval.
